...
class TOPOS(object):
    ...
    def __init__(self, original_polys, width):
        ...
        self.cur_polys = []
        self.width = width
        self.NFPAssistant = NFPAssistant1.NFPAssistant(self.polys, store_nfp=False, get_all_nfp=True, load_history=True)
    ...
    def run(self):
        ...
        for i in range(1, len(self.polys)):
            ...
            self.cur_polys.append(GeoFunc.getSlide(self.polys[i], target_position[0] - reference_point[0],
...
if __name__ == '__main__':
    ...
    nfp_ass = NFPAssistant1.NFPAssistant(polys, store_nfp=False, get_all_nfp=True, load_history=True)
    # print(datetime.datetime.now(),"计算完成NFP")
    starttime = datetime.datetime.now()
    blf = BottomLeftFill(1500, polys, vertical=False, NFPAssistant=nfp_ass)
